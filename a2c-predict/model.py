...
class ActorCritic(nn.Module):
	...
	def forward(self, inputs, batch_size=1):
		...
		split_4 = F.relu(self.a_fc5(inputs[:, 4:5, -1]))
		split_5 = F.relu(self.a_fc6(inputs[:, 5:6, -1]))
		split_6 = F.relu(self.a_fc6(inputs[:, 6:7, :2]))
		...
		split_6 = F.relu(self.c_fc6(inputs[:, 6:7, :2]))
